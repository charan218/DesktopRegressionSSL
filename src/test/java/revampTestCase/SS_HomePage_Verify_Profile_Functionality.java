...
public class SS_HomePage_Verify_Profile_Functionality 
{
	...
	public void Profile() throws Exception
	{
		try 
		{
			...
			Utils.waitForElementPresence(Personal_Info_Page.Edit_Profile_Button());
			Personal_Info_Page.Edit_Profile_Button().click();
			PIP_Action.execute_EditProfile_Button(iTestCaseRow);
			Assert.assertEquals( title , "Personal Information | Shoppers Stop");
