...
public class SS_Checkout_Public_Verify_Error_Message_For_Empty_Delivery_Address {
	...
	public void main() throws Exception {
		try {
			...
			if(ExcelUtils.getCellData(iTestCaseRow, Constant.UserType).equals("Public")){
				...
				Utils.waitForElementTOclick(Checkout_Page.LoginDetails.ContinueAsGuest());
				System.out.println("Clicked on Continue Button as Guest");
				Thread.sleep(5000);
				...
				Log.info("User phone number is entered successfully");
				...
				CheckOut_Action.ValidateErrorMessageForEmptyDeliveryAddress(iTestCaseRow);
				}
			}
			...
			if (!BaseClass.errorValidation.isEmpty()) {
				System.out.println(BaseClass.errorValidation);
