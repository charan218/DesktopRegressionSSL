...
public class SS_PDP_Private_Verify_ProductDetails_StyleNotes_BrandInfo_ReturnAndExchange {
	...
	public void main() throws Exception {
		try {
			...
			Utils.waitForPageLoad();
			PDP_Action.verify_ProductDetailsAndCare_StyleNotes_BrandInfo_ReturnandExchange();
