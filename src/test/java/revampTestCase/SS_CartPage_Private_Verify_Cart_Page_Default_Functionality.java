...
public class SS_CartPage_Private_Verify_Cart_Page_Default_Functionality {
	...
	public void main() throws Exception {
		try {
			...
			System.out.println("Cart page default content");
			Cart_Action.Verify_CartPage_Default_Content(iTestCaseRow);
