 ...
 * <p style="font-size:19px"><b>Description -</b>This Test Case verifies whether all the links are clickable in the footer page.</p>
...
public class SS_Footer_FirstCitizenRelated_Verify_All_Links_Are_Clickable {
	...
	public void main() throws Exception {
		try {
			...
			System.out.println("Navigated to First citiczen page succefully");
			HomePage_Action.verifyFirstCitizenRelatedLinks();
			ExcelUtils.setCellData("Pass", iTestCaseRow, Constant.result);
			Log.info("Verification of firstcitizen links for guest user successfull");
			...
			Log.info("Verification of firstcitizen links for guest for guest user failed");
