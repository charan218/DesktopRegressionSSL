 ...
 * <p style="font-size:19px"><b>Description -</b>This Test Case verifies all the payment mode availblity for the product.</p>
...
public class SS_Checkout_Private_Verify_Happy_Path_CheckOut {
	...
	public void main() throws Exception {
		try {
			...
			if(ExcelUtils.getCellData(iTestCaseRow, Constant.UserType).equals("Public")){
				...
				CheckOut_Action.validateNumberOfDefaultPaymentMode();
				System.out.println("Navigated till payment page");
				CheckOut_Action.Verify_OnClicking_Payment_Mode_Expand_And_Collapse();
			}
