...
public class SS_ProfilePage_Multiple_Address_Only_SingleDefaultAddress {
	...
	public void Profile() throws Exception
	{
		try 
		{
			...
			Utils.waitForElementPresence(Personal_Info_Page.addresses_Link());
			Thread.sleep(1500);
			Assert.assertTrue(PIP_Action.checkNumberOfAddresses_and_singleDefaultAddress());
