...
public class SS_HomePage_Public_Verify_MainMenu_ToolTip {
	...
	public void main() throws Exception {
		try {
			...
			HomePage_Action.HomePage_Verify_MainMenu_ToolTip1(iTestCaseRow);
			Log.info("Verification check for home page Main Menu tool tip successful");
			HomePage_Action.HomePage_Verify_L2Menu_ToolTip(iTestCaseRow);
