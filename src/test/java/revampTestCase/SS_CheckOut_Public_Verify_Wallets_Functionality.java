...
import pageObjects.Checkout_Page.Paymentinfo;
...
public class SS_CheckOut_Public_Verify_Wallets_Functionality {
		...
		try {
			...
			if(ExcelUtils.getCellData(iTestCaseRow, Constant.UserType).equals("Public")){
				...
				if(Checkout_Page.GuestOTPPopup().isDisplayed()){
					...
					Utils.scrollingToPageElement(Paymentinfo.ProceedToPaymentButton());
