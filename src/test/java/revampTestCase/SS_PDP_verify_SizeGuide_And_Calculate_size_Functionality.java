 ...
 * 
 * <h2 style=
 * "text-align:center;">SS_PDP_verify_SizeGuide_And_Calculate_size_Functionality</h2>
 * <p style="font-size:19px">
 * <b>Description -</b>This Test Case verify the size guide and calculate size
 * link on PDP page.
 * </p>
...
public class SS_PDP_verify_SizeGuide_And_Calculate_size_Functionality {
	...
	public void main() throws Exception {
		try {
			...
			Thread.sleep(5000);
			PDP_Action.PDP_Verify_size_Guide_And_calculate_Link(iTestCaseRow);
			System.out.println("Size Guide and calculate your size both link are verified");
