 ...
 * <p style="font-size:19px"><b>Description -</b>This Test Case verifies checkout flow using Gift Card for registered user</p>
...
public class SS_CheckOut_Private_Verify_GiftCard_Functionality {
