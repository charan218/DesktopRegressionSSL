 ...
 * 
 * <h2 style=
 * "text-align:center;">SS_CheckOut_AlreadyLoginUser_OrderUsingNetBanking</h2>
 * <p style="font-size:19px">
 * <b>Description -</b>This Test Case verifies checkout flow using credit card for quest user
 * </p>
 ...
 * <tr>
 * <td>emailId</td>
 * <td>Email id of the registered user</td>
 * </tr>
 * <tr>
 * <td>password</td>
 * <td>Password for the registered user</td>
 * </tr>
 * <tr>
 ...
 * </tr>
 * <tr>
 * <td>netbankingBankSelection</td>
 * <td>Bank selection criteria('SelectBankFromDropdown' in case selected bank is
 * from the drop down list, 'SelectBankFromOptionList' in case selected bank is
 * from the visible list)</td>
 * </tr>
 * <tr>
 * <td>bank</td>
 * <td>Bank through which payment is to be done</td>
 * </tr>
 * </table>
 * <br>
 * <br>
...
public class SS_Checkout_Public_Verify_Credit_Card_Scenario {
	...
	public void main() throws Exception {
		try {
			...
			if (ExcelUtils.getCellData(iTestCaseRow, Constant.UserType).equals("Public")) {
				...
				Utils.waitForElementPresence2(Checkout_Page.GuestOTPPopup());
				Thread.sleep(2000);
