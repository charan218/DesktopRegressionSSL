...
public class SS_PLP_Verify_QuickView_Details {
	...
	public void main() throws Exception {
		try {
			...
			Thread.sleep(2000);
			Utils.verifyElement(ProductListing_Page.secondproduct());
			Utils.mouseHover(ProductListing_Page.secondproduct());
			Thread.sleep(2000);
			Log.info("Mouse hovered over first product image");
			Utils.jsClick(ProductListing_Page.ProductQuickViewTag());
			Thread.sleep(2000);
