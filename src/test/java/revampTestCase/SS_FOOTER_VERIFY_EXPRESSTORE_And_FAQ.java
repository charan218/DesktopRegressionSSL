 ...
 * 
 * <h2 style=
 * "text-align:center;">SS_Footer_verify_Express_Store_pickUp_Link</h2>
 * <p style="font-size:19px">
 * <b>Description -</b>This Test Case verifies express store pick up link and
 * navigate express store and display all the frequently asked questions
 * </p>
...
public class SS_FOOTER_VERIFY_EXPRESSTORE_And_FAQ {
	...
	public void main() throws Exception {
		try {
			...
			Footer_Action.verfiyExpressStore();
			System.out.println("ExpressStore link is verified ANd All the FAQ Are Listed");
