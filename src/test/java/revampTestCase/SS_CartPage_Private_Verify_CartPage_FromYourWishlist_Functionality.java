...
public class SS_CartPage_Private_Verify_CartPage_FromYourWishlist_Functionality {
		...
		public void main() throws Exception {
			try {
				...
				Utils.waitForPageLoad();
				Thread.sleep(5000);
				Cart_Action.Verify_CartPage_FromYourWishlist_Functionality(iTestCaseRow);
				System.out.println("verifying cart page from wish list Functionality verified  and it is working ");
				...
				Log.info(
						"verifying cart page from wish list Functionality - Public View failed");
