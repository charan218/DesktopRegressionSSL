...
public class SS_ProfilePage_AddMultipleAddress {
	...
	public void main() throws Exception {
		try {
			...
			Utils.jsClick(Home_Page.profileLink());
			...
			Thread.sleep(2000);
			Utils.waitForElementTOclick(MyAccount_Page.ProfilePage.Addresses());
			...
			Thread.sleep(2000);
			MyAccount_Action.ChangeDefaultAddress();
			Thread.sleep(2000);
			...
			Utils.waitForElementTOclick(MyAccount_Page.GlobalMsg());
