...
public class FCC_Page extends BaseClass {
	...
	public static WebElement FCCGuestUserSignUp() throws Exception {
		...
		try {
			Log.info("Locating Sign Up link on Buy First Citizen membership Page");
			//element = Driver.findElement(By.xpath("//a[text()='Sign Up']"));
			//
			element = Driver.findElement(By.xpath("//a[@id='fcc-anonymous-signup']"));
			//
			
			Log.info("Sign Up link found on Buy First Citizen membership Page");
		} 
		catch (Exception e) {
			Log.error("Exception in Class FCC_Page | Method FCCGuestUserSignUp");
			Log.error("Sign Up link does not exist on Buy First Citizen membership Page");
			throw e;
		}
	...
	public static class FCC_Form {
		...
		public static WebElement FCCForm_DateOfBirth() throws Exception {
			...
			try {
				Log.info("Locating DOB Calender on FCC Form");
				System.out.println(Driver.findElement(By.xpath("//input[@id='register.dateOfBirth']/following-sibling::button")).getLocation());
				
				element = Driver.findElement(By.xpath("//input[@id='register.dateOfBirth']/following-sibling::button"));
		...
		public static WebElement selectMonthOfBirth() {
			try {
				Log.info("Locating Month ListBox of DOB Calender on FCC Form");
				element = Driver.findElement(By.xpath("//select[@class='ui-datepicker-month']"));
				Log.info("Month ListBox found on FCC Form");

			} catch (Exception e) {
				Log.error("Exception in Class FCC_Form|FCC_Page | Method selectMonthOfBirth");
				Log.error("Month ListBox does not exist on FCC Form");
				throw e;
			}
			return element;
		...
		public static WebElement selectYearOfBirth() {
			try {
				Log.info("Locating Year ListBox of DOB Calender on FCC Form");
				element = Driver.findElement(By.xpath("//select[@class='ui-datepicker-year']"));
				Log.info("Year ListBox found on FCC Form");

			} catch (Exception e) {
				Log.error("Exception in Class FCC_Form|FCC_Page | Method selectYearOfBirth");
				Log.error("Year ListBox does not exist on FCC Form");
				throw e;
			}
			return element;
		...
		public static WebElement selectDayOfBirth() {
			try {
				Log.info("Locating Year Day of DOB Calender on FCC Form");
				element = Driver.findElement(By.xpath("//td[@data-handler='selectDay']/a[.='26']"));
				Log.info("Day found on FCC Form");

			} catch (Exception e) {
				Log.error("Exception in Class FCC_Form|FCC_Page | Method selectDayOfBirth");
				Log.error("Day does not exist on FCC Form");
				throw e;
			}
			return element;
		...
		///////////////////////////
		public static WebElement FCCForm_Card_Name() throws Exception {
	...
	public static class FCC_Links_Footer {
		...
		public static WebElement FirstCitizenLink() throws Exception {
			...
			try {
				Log.info("Locating Become a Member link on FC non member page");
				element = Driver.findElement(By.xpath("//a[text()='Become a Member']"));
				Log.info("Become a Member link found on FC non member page");

			} catch (Exception e) {
				Log.error("Exception in Class FCC_Form|FCC_Page | Method FirstCitizenLink");
				Log.error("Become a Member link does not exist on FC non member page");
				throw e;
			}
	...
	public static class FCC_User_Registration {
		...
		public static WebElement Firstname_Lastname() throws Exception {

			try {
				Log.info("Locating First_name and Last_name element");
				element = Driver.findElement(By.xpath("//input[@id='signupFullName']"));
		...
		public static WebElement Continue_Button() throws Exception {
			...
			try {
				...
				element = Driver.findElement(By.xpath("//div[@class='register-wrap']//div[@class='stepOne']//button[contains(.,'Continue')]"));
	...
	public static WebElement newbutt()
	{
		return element=Driver.findElement(By.xpath("//a[@class='view-btn']"));
	}
